...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
	...
	<input type="hidden" name="orderShipping.receiverName" value="杨云龙"/>
	<input type="hidden" name="orderShipping.receiverMobile" value="18888888888"/>
	<input type="hidden" name="orderShipping.receiverState" value="哈尔滨"/>
	<input type="hidden" name="orderShipping.receiverCity" value="哈尔滨"/>
	<input type="hidden" name="orderShipping.receiverDistrict" value="南岗区"/>
	<input type="hidden" name="orderShipping.receiverAddress" value="黑龙江大学"/>
</form>
		...
		<div class="shipment">
			<div class="shipOrder" id="ylsorder2">
				<div class="sOrders">
					...
					<div class="sOrders">
						<div class="scon">
							<strong>淘金速运</strong>负责配送。<br>商品下单后尽快为您发货
						</div>
					</div>
